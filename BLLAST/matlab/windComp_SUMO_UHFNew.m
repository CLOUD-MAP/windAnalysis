...
%                radarGrid.u_mps(iFlight, iHeight) = 
            ...
            shg
            plotName = sprintf('uhf_%4.4d%2.2d%2.2d_%2.2d_1.png', ...
            ...
            plotName = sprintf('uhf_%4.4d%2.2d%2.2d_%2.2d_2.png', ...
                procYear, procMonth, procDay, iFlight);
            print([outDir plotName], '-dpng')
            shg
            % -------
            ...
            ylabel('Height (m)')
            suptitle([datestr(begTime) ' - ' datestr(endTime)], 'fontsize', fontSize)
            plotName = sprintf('uhf_%4.4d%2.2d%2.2d_%2.2d_3.png', ...
                procYear, procMonth, procDay, iFlight);
            print([outDir plotName], '-dpng')
            shg
            % -------
            ...
            ylabel('Height (m)')
            suptitle([datestr(begTime) ' - ' datestr(endTime)], 'fontsize', fontSize)
            plotName = sprintf('uhf_%4.4d%2.2d%2.2d_%2.2d_4.png', ...
                procYear, procMonth, procDay, iFlight);
            print([outDir plotName], '-dpng')
            shg
